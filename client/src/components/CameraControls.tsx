      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <Button
          ...
          style={{
            ...
            color: "#fff",
            border: "1px solid rgba(255, 255, 255, 0.1)",
            minWidth: isOpen ? "auto" : "120px",
          }}
        >
          <Camera className="h-4 w-4 mr-2" />
          {isOpen ? "Hide Settings" : "Camera Settings"}
        </Button>
      </div>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ color: "#3b82f6", fontWeight: "bold" }}>
                    {currentFollowOffset.x.toFixed(1)}
                  </span>
                </div>
                <Slider
                  ...
                  onValueChange={(values) =>
                    setCurrentFollowOffset({
                      ...currentFollowOffset,
                      x: values[0],
                    })
                  }
                  onValueCommit={(values) =>
                    setFollowOffset({ ...followOffset, x: values[0] })
                  }
                  min={-30}
                  max={30}
                  step={0.5}
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ color: "#3b82f6", fontWeight: "bold" }}>
                    {currentFollowOffset.y.toFixed(1)}
                  </span>
                </div>
                <Slider
                  ...
                  onValueCommit={(values) =>
                    setFollowOffset({ ...followOffset, y: values[0] })
                  }
                  min={0}
                  max={30}
                  step={0.5}
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ color: "#3b82f6", fontWeight: "bold" }}>
                    {currentFollowOffset.z.toFixed(1)}
                  </span>
                </div>
                <Slider
                  ...
                  onValueCommit={(values) =>
                    setFollowOffset({ ...followOffset, z: values[0] })
                  }
                  min={-30}
                  max={30}
                  step={0.5}
            ...
            >
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={(values) =>
                    setCurrentFpvOffset({ ...currentFpvOffset, x: values[0] })
                  }
                  onValueCommit={(values) =>
                    setFpvOffset({ ...fpvOffset, x: values[0] })
                  }
                  min={-3}
                  max={3}
                  step={0.1}
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={(values) =>
                    setCurrentFpvOffset({ ...currentFpvOffset, y: values[0] })
                  }
                  onValueCommit={(values) =>
                    setFpvOffset({ ...fpvOffset, y: values[0] })
                  }
                  min={-3}
                  max={3}
                  step={0.1}
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={(values) =>
                    setCurrentFpvOffset({ ...currentFpvOffset, z: values[0] })
                  }
                  onValueCommit={(values) =>
                    setFpvOffset({ ...fpvOffset, z: values[0] })
                  }
                  min={-3}
                  max={3}
                  step={0.1}
